...
class MyServices{
  ...
  static const URL_DELETE = "https://smmizan.com/appWorld/flutter/crud/deleteData.php";
  ...
  Future<String> deleteData(Model model) async{
    final response = await Http.post(URL_DELETE,body: model.toJsonUpdate());
    if(response.statusCode == 200){
      print('Response is : ${response.body}');
      return response.body;
